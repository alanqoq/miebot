...
public record PluginContext(
    ...
    public PluginContext(BotId botId, BotEnvironment environment, String pluginId,
            String configurationJson, MessageSender messageSender, PluginLogger logger) {
        this(botId, environment, pluginId, configurationJson, messageSender, logger, PluginStorage.denied());
    }
