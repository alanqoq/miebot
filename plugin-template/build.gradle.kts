...
dependencies {
    ...
    compileOnly("com.mieai.qqbot:qqbot-plugin-api:1.0.4")
    compileOnly("com.mieai.qqbot:qqbot-plugin-spi:1.0.4")
    testImplementation("com.mieai.qqbot:qqbot-plugin-testkit:1.0.4")
