...
data class CreateBotRequest(
    ...
    val enabled: Boolean,
    @field:NotBlank @field:Size(max = 4096) val appSecret: String?,
    @field:Min(1_048_576) @field:Max(268_435_456)
    val maxMediaUploadBytes: Long? = BotDefinition.DEFAULT_MAX_MEDIA_UPLOAD_BYTES,
)
