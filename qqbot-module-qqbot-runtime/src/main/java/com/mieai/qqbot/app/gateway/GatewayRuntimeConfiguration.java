...
public class GatewayRuntimeConfiguration {
    ...
    BotOpenApiClientProvider botOpenApiClientProvider(
            BotRepository botRepository,
            AppSecretCipher appSecretCipher,
            GatewayRuntimeProperties properties) {
        return new ProductionBotOpenApiClientProvider(
                botRepository,
                appSecretCipher,
                environment -> clientOptions(properties, environment));
    }
    ...
    @Bean(destroyMethod = "close")
    DefaultBotGatewayEventBus botGatewayEventBus() {
        return new DefaultBotGatewayEventBus();
    }
    ...
    BotSupervisor botSupervisor(
            ...
            ObjectProvider<RobotPluginArtifactHashes> pluginArtifactHashes) {
